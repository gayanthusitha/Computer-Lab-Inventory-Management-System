...
public class DonatedInventory extends javax.swing.JFrame {

    public DonatedInventory() {
        initComponents();
        showTableDate();
    }
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Item Deatails", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Georgia", 1, 12))); // NOI18N
        ...
        txtItemNo.setFont(new java.awt.Font("Georgia", 0, 15)); // NOI18N
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(cmbCategory, javax.swing.GroupLayout.Alignment.LEADING, 0, 229, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(txtReceivedBy, javax.swing.GroupLayout.Alignment.LEADING)))
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        //Get the values
        String itemNumber = txtItemNo.getText();
        ...
        if (itemNumber.isEmpty() || itemName.isEmpty() || category.isEmpty() || brand.isEmpty() || qty.isEmpty() || (date == null || date.isEmpty()) || receivedBy.isEmpty() || location.isEmpty() || note.isEmpty()) {
            ...
            try {
                ...
                String checkQuery = "SELECT COUNT(*) FROM donateditems WHERE item_number = ? OR serial_number = ?";
                PreparedStatement checkStatement = connection.prepareStatement(checkQuery);
                checkStatement.setString(1, itemNumber);
                checkStatement.setString(2, serialNumber);
                ...
                if (count > 0) {
                    JOptionPane.showMessageDialog(null, "An item with the same item number or serial number already exists.", "Error", JOptionPane.ERROR_MESSAGE);
                    ...
                    String query = "INSERT INTO donateditems (item_number, item_name, category, brand, serial_number, qty, receved_date, receved_by, location, note) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                    PreparedStatement preparedStatement = connection.prepareStatement(query);
                    ...
                    preparedStatement.setString(8, receivedBy);
    ...
    private void tblDonatedItemsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDonatedItemsMouseClicked
        DefaultTableModel d1 = (DefaultTableModel) tblDonatedItems.getModel();
        int SelectIndex = tblDonatedItems.getSelectedRow();

        txtItemNo.setText(d1.getValueAt(SelectIndex, 0).toString());
    ...
    private void txtSearchKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyPressed
        ...
        if (!searchCategory.isEmpty()) {
            try {
                ...
                String query = "SELECT * FROM donateditems WHERE category LIKE ?";
                PreparedStatement preparedStatement = connection.prepareStatement(query);
                ...
                DefaultTableModel model = (DefaultTableModel) tblDonatedItems.getModel();
                model.setRowCount(0);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            String query = "UPDATE donateditems SET item_name = ?, category = ?, brand = ?, serial_number = ?, qty = ?, receved_date = ?, receved_by = ?, location = ?, note = ? WHERE item_number = ?";
            PreparedStatement preparedStatement = connection.prepareStatement(query);
            ...
            preparedStatement.setString(10, itemNo);
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        if (tblDonatedItems.getSelectedRow() == -1) {
        ...
        try {
            ...
            String query = "DELETE FROM donateditems WHERE item_number = ?";
            PreparedStatement preparedStatement = connection.prepareStatement(query);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonatedInventory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void generateAndDisplayQRCode(String itemName, String category, String brand, String serialNumber, String location) {
        ...
        try {
            ...
            Path path = FileSystems.getDefault().getPath("D:\\SLIATE (HND-IT)\\Semester - iv\\Project (4052)\\Lab_Inventory_Management_System\\qrcode\\Donated_Items\\qr_code.png");
    ...
    private void generateAndDisplayBarCode(String text) {
        int width = 450;
        int height = 60;
        String filePath = "D:\\SLIATE (HND-IT)\\Semester - iv\\Project (4052)\\Lab_Inventory_Management_System\\barcode\\Donated_Items\\bar_code.png";
